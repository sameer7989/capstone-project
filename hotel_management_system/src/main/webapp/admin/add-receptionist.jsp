        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6 bg-secondary">
          <div class="card" style="border-radius: 15px;">
           <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Enter Receptionist Details</h2>
				<h5 class="text-success">${success}</h5>
				<h5 class="text-danger">${failed }</h5>
              <form action="/admin/addReceptionist" method="post">
                ...
                <div class="form-outline mb-4">
                  ...
                  <input type="email" id="form3Example3cg" class="form-control form-control-lg" name="emailId" required />
                </div>
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="text" id="form3Example4cdg" class="form-control form-control-lg" name="mobile_number" required />
                </div>
