      ...
      <div class="container">
        <div class="d-sm-flex">
          <div>
            ...
            <br />
              <a class="btn btn-primary btn-lg" onclick="javascript:document.loginform.submit()" name="submit">ADMIN LOGIN</a>
              <form name="loginform" action="/admin/admin-dashboard.jsp" method="post" hidden="true">
      				<input hidden type="submit" value="/admin/admin-dashboard.jsp" />
			</form>
