    ...
    <div id="wrapper" class="toggled">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="..receptionist/booking-info.jsp">Rooms Info</a>
                </li>
                <li>
                  <a href="../receptionist/check-bill.jsp">Check Customer Bill</a>
              </li>
                <li>
                    <a href="ShowAllCustomers.jsp">Show All Customers</a>
                </li>
                <li>
                    <a href="ShowAllReceptionists.jsp">SHow All Receptionists</a>
                </li>
