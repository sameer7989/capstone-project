      ...
      <div class="container">
        <div class="d-sm-flex">
          <div>
            ...
            <br />
              <a class="btn btn-primary btn-lg" onclick="javascript:document.userDashBoardForm.submit()" name="submit">BOOK ROOM</a>
              <form name="userDashBoardForm" action="/customer/user-dashboard.jsp" method="post" hidden="true">
      				<input hidden type="submit" value="/customer/customer-dashboard.jsp" />
			</form>
